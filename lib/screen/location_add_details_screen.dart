...
class LocationAddDetailScreen extends StatefulWidget {
  final String id;

  const LocationAddDetailScreen({
    Key? key,
    required this.id,
  }) : super(key: key);
  ...
  _LocationAddDetailScreenState createState() =>
      _LocationAddDetailScreenState();
}

class _LocationAddDetailScreenState extends State<LocationAddDetailScreen> {
  late String id;
  ...
  // Future<void> _getUserLocationAndAddMarker() async {
  ...
  //     _latitude = 13.736717;
  //     _longitude = 100.523186;
  //     _updateMarkerPosition(LatLng(_latitude, _longitude));
  //     return;
  //   }
  ...
  //   _updateMarkerPosition(userPosition);
  // }
                        ...
                        Container(
                          ...
                          () async {
                            if (nameController.text.isEmpty) {
                              ...
                              if (await addLocation(locationModel, context)) {
                                setState(() {
                                  nameController.text = "";
                                  _latitude = 13.736717;
                                  _longitude = 100.523186;
